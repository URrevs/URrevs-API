...
//               brandsInfo.push({name: name, url: "https://www.gsmarena.com/"+url});
//             });
//             resolve(brandsInfo);
//           }
//           else{
...
// }
// // get toxic brands
// targetsRouter.get("/toxic", async(req, res, next)=>{
//   let all = await getBrandsInfo();
//   COMPANY.find({}, {_id: 0, name: 1}).then((comps)=>{
//     let b = [];
//     for(c of comps){
//       b.push(c.name);
//     }
